  ...
  return (
    <>
      <div className="flex flex-col justify-between items-center h-screen bg-gray-800 md:max-w-lg m-auto">
        ...
        <div className="flex flex-col justify-between items-center py-10 text-white text-center h-1/2">
          <div className="flex flex-col px-3">
            <h1 className="text-3xl pb-2">The Lows List</h1>
            <p className="">Rank your favorite songs from <i>THE LOWS</i> as you listen.</p>
            <br></br>
            <p className="">Submit your favorites and see how they rank compared to the rest of mike's listeners.</p>
          </div>
          <div className="flex flex-col w-3/4 items-center">
            <Link href="/album" legacyBehavior>
              <a className="btn rounded-3xl w-3/4 bg-orange-700 py-3 mb-4 px-4">Create List</a>
            </Link>
